...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    roll_count, total, one = 1, 0, False
...
def is_swap(player_score, opponent_score):
    ...
    return difference == (opponent_score//10)%10
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    previous_turn0, previous_turn1 = 0, 0
    while score0 < goal and score1 < goal:
        if who == 0:
            dice_rolled = strategy0(score0, score1)
            points_scored = take_turn(dice_rolled, score1, dice)
            score0 += points_scored
            if feral_hogs and abs(dice_rolled-previous_turn0) == 2:
                score0 += 3
            if is_swap(score0, score1):
                score0, score1 = score1, score0
            previous_turn0 = points_scored
            
        else:
            dice_rolled = strategy1(score1, score0)
            points_scored = take_turn(dice_rolled, score0, dice)
            score1 += points_scored
            if feral_hogs and abs(dice_rolled-previous_turn1) == 2:
                score1 += 3
            if is_swap(score1, score0):
                score0, score1 = score1, score0
            previous_turn1 = points_scored
    ...
    def say(score0, score1):
        if who == 0:
            ...
            if change > running_high:
                print(change, 'point(s)! That\'s the biggest gain yet for Player 0')
                new_running_high = change
            return announce_highest(who, score0, new_running_high)
        else:
            change = score1 - last_score
            new_running_high = running_high
            if change > running_high:
                print(change, 'point(s)! That\'s the biggest gain yet for Player 1')
                new_running_high = change
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    dice_count, highest_count, highest_score = 1, 1, 1
    while dice_count <= 10:
        average_func = make_averaged(roll_dice, trials_count)
        average = average_func(dice_count, dice)
        if average > highest_score:
            highest_count = dice_count
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(score_after_bacon, opponent_score):
        if opponent_score > score_after_bacon:
            return 0
        return num_rolls
